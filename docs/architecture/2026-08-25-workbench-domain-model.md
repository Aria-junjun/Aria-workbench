...
| 实际供应关系 | Supplier Assignment | 产品族在某个有效期间的默认主供/备供关系，或某个 SKU 的例外供应关系 | 不是“货盘上出现过” |
...
- 实际供应关系必须有供应商、产品族或 SKU、有效期间和来源；产品族默认关系覆盖全部有效 SKU，SKU 例外关系优先。
...
2. **实际供应关系与货盘关系已完成第一阶段分离。** 当前已支持产品族默认关系、SKU 例外关系、有效期和变更依据；后续仍需把关系变更与待办完成动作进一步联动。
